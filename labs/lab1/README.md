...
**Screenshot: HTTP Request to "http://example.com"**
![HTTP Request to "http://example.com"](images/HTTP_Request_Example_com.png)

**Screenshot: HTTP Response from "http://example.com"**
![HTTP Response from "http://example.com"](images/HTTP_Response_Example_com.png)

**Screenshot: HTTP Stream for "http://example.com"**
![HTTP Stream for "http://example.com"](images/HTTP_Stream_Example_com.png)

**Screenshot: HTTP Stream for "http://example.com/index.html" which shows 404 Not Found**:
...
#### 1.
**Screenshot: terminal showing the HTTP Request and HTTP response from the server**
![terminal showing the HTTP Request and HTTP response from the server. ](images/Telnet_Wireshark_Terminal.png)

#### 2.
**Screenshot:  HTTP Request message in Wireshark**
...
#### 3. 
**Screenshot: HTTP Response message in Wireshark that the server responded**
...
**Screenshot: CGI program is invoked properly in a browser**
![CGI program is invoked properly in a browser](images/CGI_Application_1.png)

#### b:
**Screenshot: Source Code of the C code I wrote on my own and the resulting webpage**
...
**Screenshot: developed a simple helloworld.php PHP page with my name**
![developed a simple helloworld.php PHP page with my name](images/PHP_Test_Browser.png)

#### b:
**Screenshot: developed and deployed an echo Web application in PHP**
...
**Screenshot: HTTP GET Request for the echo.php page with my name in the data**
![HTTP GET Request for the echo.php page with my name in the data](images/Echo_PHP_GET_Wireshark_Request.png)

**Screenshot: HTTP GET Response for the echo.php page with my name in the data**
